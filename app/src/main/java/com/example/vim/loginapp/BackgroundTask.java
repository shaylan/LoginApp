    ...
    protected String doInBackground(String... params) {
        ...
        if(method.equals("register")) //If it is register then the if statement below will be followed
        {
            try {
                ...
                String data = URLEncoder.encode("C_name", "UTF-8") +"="+URLEncoder.encode(name, "UTF-8") +"&"+
                        URLEncoder.encode("C_email", "UTF-8") +"="+URLEncoder.encode(email, "UTF-8") +"&"+
                        URLEncoder.encode("C_password", "UTF-8") +"="+ URLEncoder.encode(password, "UTF-8");
        ...
        else if (method.equals("login"))
        {
            try {
                ...
                //Below encodes the data
                String data = URLEncoder.encode("C_email", "UTF-8") +"="+URLEncoder.encode(email, "UTF-8") +"&"+
                        URLEncoder.encode("C_password", "UTF-8") +"="+ URLEncoder.encode(password, "UTF-8");
